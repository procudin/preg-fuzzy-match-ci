...
#line 8 "../preg_parser.y"
    ...
    public function assign_subexprs($node, $subexprs = []) {
        if ($node->type == qtype_preg_node::TYPE_NODE_SUBEXPR && $node->number !== null && $node->number !== -1) {
            $subexprs []= $node->number;
        }
        if ($node->is_subpattern() || $node === $this->root) {
            foreach ($subexprs as $supexpr) {
                $node->submatches []= $supexpr;
            }
        }
        if (is_a($node, 'qtype_preg_operator')) {
            foreach ($node->operands as $operand) {
                $this->assign_subexprs($operand, $subexprs);
            }
        }
    }
...
static public $yy_action = array(
 /*     0 */    29,   28,   71,    1,   14,   20,   16,   15,   12,   33,
 /*    10 */    22,   21,   10,    5,    2,   29,   25,   57,   19,   14,
 /*    20 */    17,    9,   15,    8,   33,   22,   21,   10,    5,    2,
 /*    30 */    27,   30,   57,    3,   13,    6,   11,   18,   57,   33,
 /*    40 */    22,   35,   10,    5,    2,   36,   28,   57,   57,   14,
 /*    50 */    57,   57,   15,   57,   33,   22,   21,   10,    5,    2,
 /*    60 */    31,   32,   57,   57,   13,   57,   57,   18,   57,   33,
 /*    70 */    22,   35,   10,    5,    2,    7,   30,   57,   57,   13,
 /*    80 */    57,   57,   18,   57,   33,   22,   35,   10,    5,    2,
 /*    90 */    34,   30,   57,   57,   13,   57,   57,   18,   57,   33,
 /*   100 */    22,   35,   10,    5,    2,   23,   28,   57,   57,   14,
 /*   110 */    57,   57,   15,   57,   33,   22,   21,   10,    5,    2,
 /*   120 */    26,   28,   57,   57,   14,   57,   57,   15,   57,   33,
 /*   130 */    22,   21,   10,    5,    2,   24,   30,   57,   57,   13,
 /*   140 */    57,   57,   18,   57,   33,   22,   35,   10,    5,    2,
 /*   150 */    31,   30,   57,   57,   13,   57,   57,   18,   57,   33,
 /*   160 */    22,   35,   10,    5,    2,    4,   28,   57,   57,   14,
 /*   170 */    57,   57,   15,   57,   33,   22,   21,   10,    5,    2,
 /*   180 */    57,   13,   57,   57,   18,   57,   33,   22,   35,   10,
 /*   190 */     5,    2,   57,   14,   57,   57,   15,   57,   33,   22,
 /*   200 */    21,   10,    5,    2,   57,   15,   57,   33,   22,   21,
 /*   210 */    10,    5,    2,   18,   57,   33,   22,   35,   10,    5,
 /*   220 */     2,   33,   22,   35,   10,    5,    2,   35,   10,    5,
 /*   230 */     2,
    );
 ...
 /*     0 */    -4,  146,  161,  131,  116,   11,   86,  101,   71,   56,
 /*    10 */    41,   26,  173,  185,  185,  194,  202,  202,  194,  208,
 /*    20 */   212,
);
    const YY_REDUCE_USE_DFLT = -19;
    const YY_REDUCE_MAX = 20;
    static public $yy_reduce_ofst = array(
 /*     0 */   -18,  -16,    2,  -16,   12,    0,  -16,   14,  -16,  -16,
 /*    10 */    15,  -16,  -16,   -1,  -13,  -15,  -16,  -16,   -3,  -16,
 /*    20 */   -16,
);
 ...
 /*     0 */    70,   37,   68,   70,   60,   65,   66,   58,   67,   63,
 /*    10 */    64,   62,   54,   53,   55,   44,   43,   52,   42,   41,
 /*    20 */    40,   69,   39,   49,   50,   56,   51,   47,   61,   60,
 /*    30 */    59,   58,   57,   38,   48,   45,   46,
);
...
#line 340 "../preg_parser.y"
    ...
    // Assign subexprs numbers.
    $this->assign_subexprs($this->root, [0]);
...
#line 1459 "../preg_parser.php"
#line 579 "../preg_parser.y"
    function yy_r21(){
